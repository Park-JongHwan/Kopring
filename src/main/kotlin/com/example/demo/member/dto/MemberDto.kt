...
data class MemberDtoRequest(
    ...
    fun toEntity(encodePassword: String): Member =
        Member(id, loginId, encodePassword, name, birthday, gender, email)

    fun toEntity(): Member =
        Member(id, loginId, password, name, birthday, gender, email)
}
